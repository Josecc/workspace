...
// Blank fills and right justifies a string in a field of size characters
	...
	/**
	 * <b>Purpose:</b> Checks to make sure the input is a positive double, ideal for money amounts.<br><br>
	 * <b>PreconditionL</b> There must be a scanner available in the class state variables.<br>
	 * @return number
	 */
	public static double posDoubleCheck(){
		boolean valid = false;
		double number = 0;
		...
		do{
			try{
				...
				System.err.println("Please input a positive double number.");
				keyboard.next();
			}
		}while(!valid);
